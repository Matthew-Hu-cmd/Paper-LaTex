...
% \begin{teaserfigure} %会报错啊！！！不知道怎么用teaserfigure
%   \includegraphics[width=\textwidth]{COD_Zh_translate/figures/examples.png}
...
% 开头的图片，按照列排
% \begin{figure*}[h!]
%   \begin{overpic}[width=0.1\textwidth]{example1.png}
%   \end{overpic}
%   \caption{纯测试纯测试
...
%  \includegraphics[width=0.1\textwidth]{COD_Zh_translate/figures/example1.png}
% 	\end{subfigure}	
% 		\begin{subfigure}{\textwidth}
% 		    \includegraphics[width=0.1\textwidth]{COD_Zh_translate/figures/example2.png}
% 	\end{subfigure}
% 	\vspace{-2mm}
%     \caption{我们的 CVID 网络在\textsl{D2} \textsl{Rain100H}~\cite{yang2017deeppami}上具有不同的$\beta$(左)和 $\lambda$ (右)的 \textbf{PSNR (dB) 和 SSIM 结果}}
%     \label{fig:parameter}
% \end{figure*}
